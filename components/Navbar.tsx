              ...
              <Menu>
                {({ open }) => (
                  <div className="relative">
                    <Menu.Button className={clsx(open ? "text-white" : "text-smoke-400", "flex items-center gap-x-2 font-light hover:text-white")}>
                      {/* John doe */}
                      {user?.name}
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={clsx(open && "rotate-180", "h-5 w-5 transition duration-300")}>
                        <path fillRule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clipRule="evenodd" />
                      </svg>
                    </Menu.Button>
                    <Menu.Items className="absolute right-0 top-0 z-50 mt-8 w-56 overflow-hidden rounded-lg border border-smoke-700 bg-smoke-800 py-2 shadow-sm">
